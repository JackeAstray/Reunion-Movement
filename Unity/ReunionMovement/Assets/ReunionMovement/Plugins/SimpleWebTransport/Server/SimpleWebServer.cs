...
namespace Mirror.SimpleWeb
{
    public class SimpleWebServer
    {
        ...
        /// <summary>
        /// 在指定的 <paramref name="behaviour"/> 启用时处理消息队列中的所有消息
        /// </summary>
        ...
        public void ProcessMessageQueue(MonoBehaviour behaviour)
        {
            ...
            {
                Log.Warn("[SWT-SimpleWebServer]: ProcessMessageQueue 剩余 {0} 条消息。", server.receiveQueue.Count);
            }
        }
    }
}
